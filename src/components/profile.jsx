...
function Profile() {
      ...
      try {
        ...
        if (response.status === 200) {
          ...
          if (response.data.image === "") {
            ...
            setUserProfileImg(`${apiUrl}/uploads\\${response.data.image}`);
          }
        }
      } catch (err) {
        console.log(err);
  ...
  const handleChangeImage = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(`${apiUrl}/user/picture`, formData, {
        headers: {
      ...
      if (response) {
        setUserProfileImg(`${apiUrl}/uploads\\${response.data.file}`);
        setProfileImgProp(`${apiUrl}/uploads\\${response.data.file}`);
